...
const stadtpocketAssistantRoutes = require('./routes/stadtpocketAssistantRoutes');
const stadtpocketPassRoutes = require('./routes/stadtpocketPassRoutes');
...
app.use('/public/stadtpocket', stadtpocketAssistantRoutes);
app.use('/public/stadtpocket', stadtpocketPassRoutes);
