...
window.QRAivyLPGen = (function(){
  ...
  function generate(opts){
    ...
    var qrSrc     = opts.qrSrc    || ('https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://qraivy.com/'+slug+'&color=ffffff&bgcolor=111111&margin=2');
    ...
    '<section class="lp-qr-section">'+
      '<div class="lp-qr-card">'+
        ...
        '<div class="lp-qr-info">'+
          ...
          '<div class="lp-qr-url">qraivy.com/'+slug+'</div>'+
    ...
    '<footer class="lp-footer">'+
      '<div class="lp-footer-brand">'+
        ...
        '<div class="lp-footer-info">'+
          ...
          '<div class="lp-footer-url">qraivy.com/'+slug+'</div>'+
        '</div>'+
      '</div>'+
