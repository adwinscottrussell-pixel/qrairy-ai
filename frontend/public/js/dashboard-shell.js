...
(function () {
  ...
  var NAV_ITEMS = [
    ...
    { id: 'nav-subscribers', group: 'engage',     sbDomId: 'sb-subscribers',bnDomId: 'bn-subs',      href: 'dashboard.html?section=customers', icon: '&#x1F465;', i18n: 'nav_subscribers', label: 'Customers',   mobileLabel: 'Customers',      showInSidebar: true, showInBottomNav: true,  bottomNavOrder: 4 },
